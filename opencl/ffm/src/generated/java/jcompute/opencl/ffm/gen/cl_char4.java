...
public class cl_char4 {
    ...
    private static final OfByte x$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$538:22"), groupElement("x"));
    ...
    private static final OfByte y$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$538:22"), groupElement("y"));
    ...
    private static final OfByte z$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$538:22"), groupElement("z"));
    ...
    private static final OfByte w$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$538:22"), groupElement("w"));
    ...
    private static final OfByte s0$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$541:22"), groupElement("s0"));
    ...
    private static final OfByte s1$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$541:22"), groupElement("s1"));
    ...
    private static final OfByte s2$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$541:22"), groupElement("s2"));
    ...
    private static final OfByte s3$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$541:22"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$544:22"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$544:22"), groupElement("hi"));
