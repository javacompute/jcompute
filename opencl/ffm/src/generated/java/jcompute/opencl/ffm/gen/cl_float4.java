...
public class cl_float4 {
    ...
    private static final OfFloat x$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1401:22"), groupElement("x"));
    ...
    private static final OfFloat y$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1401:22"), groupElement("y"));
    ...
    private static final OfFloat z$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1401:22"), groupElement("z"));
    ...
    private static final OfFloat w$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1401:22"), groupElement("w"));
    ...
    private static final OfFloat s0$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1404:22"), groupElement("s0"));
    ...
    private static final OfFloat s1$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1404:22"), groupElement("s1"));
    ...
    private static final OfFloat s2$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1404:22"), groupElement("s2"));
    ...
    private static final OfFloat s3$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1404:22"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1407:22"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1407:22"), groupElement("hi"));
