...
public class cl_uint2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$1095:22"),
        MemoryLayout.structLayout(
            opencl_h.C_INT.withName("s0"),
            opencl_h.C_INT.withName("s1")
        ).withName("$anon$1098:22"),
        MemoryLayout.structLayout(
            opencl_h.C_INT.withName("lo"),
            opencl_h.C_INT.withName("hi")
        ).withName("$anon$1101:22"),
        MemoryLayout.sequenceLayout(2, opencl_h.C_INT).withName("v2")
    ...
    private static final OfInt x$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1095:22"), groupElement("x"));
    ...
    private static final OfInt y$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1095:22"), groupElement("y"));
    ...
    private static final OfInt s0$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1098:22"), groupElement("s0"));
    ...
    private static final OfInt s1$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1098:22"), groupElement("s1"));
    ...
    private static final OfInt lo$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1101:22"), groupElement("lo"));
    ...
    private static final OfInt hi$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1101:22"), groupElement("hi"));
