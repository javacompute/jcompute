...
public class cl_long2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.sequenceLayout(2, opencl_h.C_LONG).withName("s"),
        MemoryLayout.structLayout(
            opencl_h.C_LONG.withName("x"),
            opencl_h.C_LONG.withName("y")
        ).withName("$anon$1190:22"),
        MemoryLayout.structLayout(
            opencl_h.C_LONG.withName("s0"),
            opencl_h.C_LONG.withName("s1")
        ).withName("$anon$1193:22"),
        MemoryLayout.structLayout(
            opencl_h.C_LONG.withName("lo"),
            opencl_h.C_LONG.withName("hi")
        ).withName("$anon$1196:22"),
        MemoryLayout.sequenceLayout(2, opencl_h.C_LONG).withName("v2")
    ).withName("$anon$1187:9");
    ...
    private static final OfLong x$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1190:22"), groupElement("x"));
    ...
    private static final OfLong y$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1190:22"), groupElement("y"));
    ...
    private static final OfLong s0$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1193:22"), groupElement("s0"));
    ...
    private static final OfLong s1$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1193:22"), groupElement("s1"));
    ...
    private static final OfLong lo$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1196:22"), groupElement("lo"));
    ...
    private static final OfLong hi$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1196:22"), groupElement("hi"));
