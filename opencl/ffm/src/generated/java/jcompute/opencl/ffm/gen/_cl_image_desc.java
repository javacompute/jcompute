...
public class _cl_image_desc {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        opencl_h.C_LONG.withName("image_width"),
        opencl_h.C_LONG.withName("image_height"),
        opencl_h.C_LONG.withName("image_depth"),
        opencl_h.C_LONG.withName("image_array_size"),
        opencl_h.C_LONG.withName("image_row_pitch"),
        opencl_h.C_LONG.withName("image_slice_pitch"),
    ...
    private static final AddressLayout buffer$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$142:7"), groupElement("buffer"));
    ...
    private static final AddressLayout mem_object$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$142:7"), groupElement("mem_object"));
