...
public class cl_uchar8 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$661:22"),
        MemoryLayout.structLayout(
            cl_uchar4.layout().withName("lo"),
            cl_uchar4.layout().withName("hi")
        ).withName("$anon$664:22"),
        MemoryLayout.sequenceLayout(8, opencl_h.C_CHAR).withName("v8")
    ).withName("$anon$655:9");
    ...
    private static final OfByte x$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$658:22"), groupElement("x"));
    ...
    private static final OfByte y$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$658:22"), groupElement("y"));
    ...
    private static final OfByte z$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$658:22"), groupElement("z"));
    ...
    private static final OfByte w$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$658:22"), groupElement("w"));
    ...
    private static final OfByte s0$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$661:22"), groupElement("s0"));
    ...
    private static final OfByte s1$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$661:22"), groupElement("s1"));
    ...
    private static final OfByte s2$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$661:22"), groupElement("s2"));
    ...
    private static final OfByte s3$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$661:22"), groupElement("s3"));
    ...
    private static final OfByte s4$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$661:22"), groupElement("s4"));
    ...
    private static final OfByte s5$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$661:22"), groupElement("s5"));
    ...
    private static final OfByte s6$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$661:22"), groupElement("s6"));
    ...
    private static final OfByte s7$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$661:22"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$664:22"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$664:22"), groupElement("hi"));
