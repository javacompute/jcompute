...
public class cl_float2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$1383:22"),
        MemoryLayout.structLayout(
            opencl_h.C_FLOAT.withName("s0"),
            opencl_h.C_FLOAT.withName("s1")
        ).withName("$anon$1386:22"),
        MemoryLayout.structLayout(
            opencl_h.C_FLOAT.withName("lo"),
            opencl_h.C_FLOAT.withName("hi")
        ).withName("$anon$1389:22"),
        MemoryLayout.sequenceLayout(2, opencl_h.C_FLOAT).withName("v2")
    ).withName("$anon$1380:9");
    ...
    private static final OfFloat x$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1383:22"), groupElement("x"));
    ...
    private static final OfFloat y$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1383:22"), groupElement("y"));
    ...
    private static final OfFloat s0$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1386:22"), groupElement("s0"));
    ...
    private static final OfFloat s1$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1386:22"), groupElement("s1"));
    ...
    private static final OfFloat lo$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1389:22"), groupElement("lo"));
    ...
    private static final OfFloat hi$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1389:22"), groupElement("hi"));
