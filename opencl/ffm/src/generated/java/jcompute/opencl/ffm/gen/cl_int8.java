...
public class cl_int8 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$1044:22"),
        MemoryLayout.structLayout(
            cl_int4.layout().withName("lo"),
            cl_int4.layout().withName("hi")
        ).withName("$anon$1047:22"),
        MemoryLayout.sequenceLayout(4, MemoryLayout.sequenceLayout(2, opencl_h.C_INT)).withName("v2"),
        MemoryLayout.sequenceLayout(2, MemoryLayout.sequenceLayout(4, opencl_h.C_INT)).withName("v4")
    ).withName("$anon$1038:9");
    ...
    private static final OfInt x$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1041:22"), groupElement("x"));
    ...
    private static final OfInt y$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1041:22"), groupElement("y"));
    ...
    private static final OfInt z$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1041:22"), groupElement("z"));
    ...
    private static final OfInt w$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1041:22"), groupElement("w"));
    ...
    private static final OfInt s0$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1044:22"), groupElement("s0"));
    ...
    private static final OfInt s1$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1044:22"), groupElement("s1"));
    ...
    private static final OfInt s2$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1044:22"), groupElement("s2"));
    ...
    private static final OfInt s3$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1044:22"), groupElement("s3"));
    ...
    private static final OfInt s4$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1044:22"), groupElement("s4"));
    ...
    private static final OfInt s5$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1044:22"), groupElement("s5"));
    ...
    private static final OfInt s6$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1044:22"), groupElement("s6"));
    ...
    private static final OfInt s7$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1044:22"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1047:22"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1047:22"), groupElement("hi"));
