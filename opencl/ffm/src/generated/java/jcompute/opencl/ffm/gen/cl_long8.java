...
public class cl_long8 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$1235:22"),
        MemoryLayout.structLayout(
            cl_long4.layout().withName("lo"),
            cl_long4.layout().withName("hi")
        ).withName("$anon$1238:22"),
        MemoryLayout.sequenceLayout(4, MemoryLayout.sequenceLayout(2, opencl_h.C_LONG)).withName("v2")
    ).withName("$anon$1229:9");
    ...
    private static final OfLong x$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1232:22"), groupElement("x"));
    ...
    private static final OfLong y$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1232:22"), groupElement("y"));
    ...
    private static final OfLong z$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1232:22"), groupElement("z"));
    ...
    private static final OfLong w$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1232:22"), groupElement("w"));
    ...
    private static final OfLong s0$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1235:22"), groupElement("s0"));
    ...
    private static final OfLong s1$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1235:22"), groupElement("s1"));
    ...
    private static final OfLong s2$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1235:22"), groupElement("s2"));
    ...
    private static final OfLong s3$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1235:22"), groupElement("s3"));
    ...
    private static final OfLong s4$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1235:22"), groupElement("s4"));
    ...
    private static final OfLong s5$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1235:22"), groupElement("s5"));
    ...
    private static final OfLong s6$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1235:22"), groupElement("s6"));
    ...
    private static final OfLong s7$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1235:22"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1238:22"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1238:22"), groupElement("hi"));
