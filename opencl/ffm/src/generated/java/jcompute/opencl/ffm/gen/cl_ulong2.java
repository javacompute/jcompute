...
public class cl_ulong2 {
    ...
    private static final OfLong x$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1286:22"), groupElement("x"));
    ...
    private static final OfLong y$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1286:22"), groupElement("y"));
    ...
    private static final OfLong s0$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1289:22"), groupElement("s0"));
    ...
    private static final OfLong s1$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1289:22"), groupElement("s1"));
    ...
    private static final OfLong lo$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1292:22"), groupElement("lo"));
    ...
    private static final OfLong hi$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1292:22"), groupElement("hi"));
