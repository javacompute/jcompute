...
public class cl_ulong4 {
    ...
    private static final OfLong x$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1304:22"), groupElement("x"));
    ...
    private static final OfLong y$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1304:22"), groupElement("y"));
    ...
    private static final OfLong z$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1304:22"), groupElement("z"));
    ...
    private static final OfLong w$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1304:22"), groupElement("w"));
    ...
    private static final OfLong s0$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1307:22"), groupElement("s0"));
    ...
    private static final OfLong s1$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1307:22"), groupElement("s1"));
    ...
    private static final OfLong s2$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1307:22"), groupElement("s2"));
    ...
    private static final OfLong s3$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1307:22"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1310:22"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1310:22"), groupElement("hi"));
