...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, opencl_h.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, opencl_h.C_SHORT).withName("__old_x"),
        opencl_h.C_SHORT.withName("__c"),
        opencl_h.C_SHORT.withName("__init"),
        opencl_h.C_LONG_LONG.withName("__a")
