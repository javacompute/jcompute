...
public class cl_int2 {
    ...
    private static final OfInt x$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$999:22"), groupElement("x"));
    ...
    private static final OfInt y$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$999:22"), groupElement("y"));
    ...
    private static final OfInt s0$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1002:22"), groupElement("s0"));
    ...
    private static final OfInt s1$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1002:22"), groupElement("s1"));
    ...
    private static final OfInt lo$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1005:22"), groupElement("lo"));
    ...
    private static final OfInt hi$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1005:22"), groupElement("hi"));
