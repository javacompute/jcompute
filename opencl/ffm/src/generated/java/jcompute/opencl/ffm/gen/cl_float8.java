...
public class cl_float8 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$1428:22"),
        MemoryLayout.structLayout(
            cl_float4.layout().withName("lo"),
            cl_float4.layout().withName("hi")
        ).withName("$anon$1431:22"),
        MemoryLayout.sequenceLayout(4, MemoryLayout.sequenceLayout(2, opencl_h.C_FLOAT)).withName("v2"),
        MemoryLayout.sequenceLayout(2, MemoryLayout.sequenceLayout(4, opencl_h.C_FLOAT)).withName("v4")
    ).withName("$anon$1422:9");
    ...
    private static final OfFloat x$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1425:22"), groupElement("x"));
    ...
    private static final OfFloat y$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1425:22"), groupElement("y"));
    ...
    private static final OfFloat z$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1425:22"), groupElement("z"));
    ...
    private static final OfFloat w$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1425:22"), groupElement("w"));
    ...
    private static final OfFloat s0$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1428:22"), groupElement("s0"));
    ...
    private static final OfFloat s1$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1428:22"), groupElement("s1"));
    ...
    private static final OfFloat s2$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1428:22"), groupElement("s2"));
    ...
    private static final OfFloat s3$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1428:22"), groupElement("s3"));
    ...
    private static final OfFloat s4$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1428:22"), groupElement("s4"));
    ...
    private static final OfFloat s5$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1428:22"), groupElement("s5"));
    ...
    private static final OfFloat s6$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1428:22"), groupElement("s6"));
    ...
    private static final OfFloat s7$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1428:22"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1431:22"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1431:22"), groupElement("hi"));
