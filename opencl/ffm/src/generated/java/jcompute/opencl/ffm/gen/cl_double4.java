...
public class cl_double4 {
    ...
    private static final OfDouble x$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1497:22"), groupElement("x"));
    ...
    private static final OfDouble y$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1497:22"), groupElement("y"));
    ...
    private static final OfDouble z$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1497:22"), groupElement("z"));
    ...
    private static final OfDouble w$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1497:22"), groupElement("w"));
    ...
    private static final OfDouble s0$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1500:22"), groupElement("s0"));
    ...
    private static final OfDouble s1$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1500:22"), groupElement("s1"));
    ...
    private static final OfDouble s2$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1500:22"), groupElement("s2"));
    ...
    private static final OfDouble s3$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1500:22"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1503:22"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1503:22"), groupElement("hi"));
