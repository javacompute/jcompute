...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_POINTER.withName("fptr"),
        opencl_h.C_POINTER.withName("rptr"),
        opencl_h.C_POINTER.withName("state"),
        opencl_h.C_INT.withName("rand_type"),
        opencl_h.C_INT.withName("rand_deg"),
        opencl_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        opencl_h.C_POINTER.withName("end_ptr")
