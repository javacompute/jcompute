...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        opencl_h.C_INT.withName("__readers"),
        opencl_h.C_INT.withName("__writers"),
        opencl_h.C_INT.withName("__wrphase_futex"),
        opencl_h.C_INT.withName("__writers_futex"),
        opencl_h.C_INT.withName("__pad3"),
        opencl_h.C_INT.withName("__pad4"),
        opencl_h.C_INT.withName("__cur_writer"),
        opencl_h.C_INT.withName("__shared"),
        opencl_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, opencl_h.C_CHAR).withName("__pad1"),
        opencl_h.C_LONG.withName("__pad2"),
        opencl_h.C_INT.withName("__flags"),
