...
public class cl_ushort8 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$853:22"),
        MemoryLayout.structLayout(
            cl_ushort4.layout().withName("lo"),
            cl_ushort4.layout().withName("hi")
        ).withName("$anon$856:22"),
        MemoryLayout.sequenceLayout(2, MemoryLayout.sequenceLayout(4, opencl_h.C_SHORT)).withName("v4"),
        MemoryLayout.sequenceLayout(8, opencl_h.C_SHORT).withName("v8")
    ).withName("$anon$847:9");
    ...
    private static final OfShort x$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$850:22"), groupElement("x"));
    ...
    private static final OfShort y$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$850:22"), groupElement("y"));
    ...
    private static final OfShort z$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$850:22"), groupElement("z"));
    ...
    private static final OfShort w$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$850:22"), groupElement("w"));
    ...
    private static final OfShort s0$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$853:22"), groupElement("s0"));
    ...
    private static final OfShort s1$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$853:22"), groupElement("s1"));
    ...
    private static final OfShort s2$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$853:22"), groupElement("s2"));
    ...
    private static final OfShort s3$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$853:22"), groupElement("s3"));
    ...
    private static final OfShort s4$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$853:22"), groupElement("s4"));
    ...
    private static final OfShort s5$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$853:22"), groupElement("s5"));
    ...
    private static final OfShort s6$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$853:22"), groupElement("s6"));
    ...
    private static final OfShort s7$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$853:22"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$856:22"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$856:22"), groupElement("hi"));
