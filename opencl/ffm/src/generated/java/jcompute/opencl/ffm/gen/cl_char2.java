...
public class cl_char2 {
    ...
    private static final OfByte x$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$520:22"), groupElement("x"));
    ...
    private static final OfByte y$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$520:22"), groupElement("y"));
    ...
    private static final OfByte s0$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$523:22"), groupElement("s0"));
    ...
    private static final OfByte s1$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$523:22"), groupElement("s1"));
    ...
    private static final OfByte lo$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$526:22"), groupElement("lo"));
    ...
    private static final OfByte hi$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$526:22"), groupElement("hi"));
